...
Pod::Spec.new do |spec|
  ...
  spec.public_header_files = ['MoonLight_macOS/MoonLight/*.h', 'MoonLight_macOS/MoonLight/AppCPU/*.h', 'MoonLight_macOS/MoonLight/AppMemory/*.h', 'MoonLight_macOS/MoonLight/MacGPU/*.h', 'MoonLight_macOS/MoonLight/SystemCPU/*.h','MoonLight_macOS/MoonLight/ANR/*.h']
